...
namespace RidePal.Services.Services
{
    ...
    {
        private const string templatePath = @"Helpers/EmailTemplate/{0}.html";
        ...
        private async Task SendEmail(UserEmailOptions userEmailOptions)
        {
            ...
            NetworkCredential networkCredential = new NetworkCredential(_smtpConfig.SenderAddress, _smtpConfig.Password);
